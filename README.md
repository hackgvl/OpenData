...
For example a "robot" to scrape iCal events could be written in C# with it feeding new event data into the API. The Meetup.com events coming from a Python tool. Facebook from Node, etc, etc.
